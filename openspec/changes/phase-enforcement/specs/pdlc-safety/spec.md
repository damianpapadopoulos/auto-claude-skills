# Delta: pdlc-safety — phase-transition enforcement

## ADDED Requirements

### Requirement: Phase-transition enforcement
...
#### Scenario: out-of-order Skill invocation is denied with a remedy
...
#### Scenario: explicit skip-attestation satisfies the gate and leaves a trail
...
#### Scenario: attestation never satisfies gating milestones
...
#### Scenario: scoping and fail-open — no false obstruction
