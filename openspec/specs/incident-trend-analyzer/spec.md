...
On-demand trend analysis across the postmortem corpus. Groups recurrences, computes MTTR/MTTD from existing incident documents, and refuses to generate reports on thin evidence so findings remain defensible.
